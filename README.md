...
This repository covers 98 of the corpus’s 104 benchmarks. Every result is verified against the exact flag generated by the corpus, `FLAG{sha256(NAME)}`, rather than against a string that merely resembles a flag.
...
The remaining six benchmarks are not included for the following reasons:
