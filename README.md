...
Worked solutions to the [XBOW Validation Benchmarks](https://github.com/xbow-engineering/validation-benchmarks), implemented using [h5i](https://github.com/h5i-dev/h5i), specifically `h5i browser` and the `h5i websec` plugin.
